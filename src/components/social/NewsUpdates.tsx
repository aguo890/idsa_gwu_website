    ...
    return (
        <section className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {newsItems.map(item => (
                    <div key={item.id} className="glass-panel p-8 rounded-2xl flex flex-col hover:-translate-y-2 hover:bg-white/10 transition-all duration-500 group border hover:border-white/20">
                        ...
                        <h4 className="text-2xl font-display font-black text-white mb-4 leading-tight group-hover:text-white/90 transition-colors">
                            {item.title}
                        </h4>
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white/70 hover:text-white transition-colors mt-auto group/btn w-fit"
                        >
                            Learn More
                            {item.isExternal ? (
